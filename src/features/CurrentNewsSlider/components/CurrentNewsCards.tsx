...
const CurrentNewsCardImage: React.FC<{ urlToImage?: string; title?: string }> = ({
    urlToImage,
    title,
}) => {
...
const CurrentNewsCardFigure: React.FC<{ urlToImage?: string; title?: string }> = ({
    urlToImage,
    title,
}) => (
